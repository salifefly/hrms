...
<html>
	<head>
		...
		<script type="text/javascript">
			function addbt(){
				var yf=$("#ckyf").datebox('getValue');
				if(yf==""){
					alert("请选择要生成工资的月份");
					return;
				}
				$.ajax({
					url:'<%=basePath%>t_salary/add',
					type:'post',
					data:{"yf":yf},
					dataType:'json',
		...
		//取消
		function rst(){
			window.location.href="<%=basePath%>t_salary/apage?pnum="+${pagenum};
		}
		//查询
		function cktj(){
			$("#ckf").submit();
...
<body>	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td class="STYLE7" style="padding-left: 50px;">工资信息管理</td>
					<td style="padding-right:10px;"><div align="right" style="padding-right: 50px;">
						<form id="ckf" action="<%=basePath%>t_salary/ck" method="post">
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="<%=basePath%>t_salary/apage?pnum=1"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="<%=basePath%>t_salary/apage?pnum=${pagenum-1}"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="<%=basePath%>t_salary/apage?pnum=${pagenum+1}"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="<%=basePath%>t_salary/apage?pnum=${pagenums}"><img src="images/last.gif" width="37" height="15"/></a></td>
